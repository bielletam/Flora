...
export default function LoginPage() {
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#E8E8E2] p-6 shadow-card">
      <h1 className="font-display font-bold text-xl text-ink mb-1">Welcome back</h1>
      ...
      <div className="mt-4 pt-4 border-t border-[#E8E8E2]">
        ...
        <p className="text-[11px] text-ghost text-center mt-2">
          Demo: alex@mindbloom.app / password123
        </p>
      </div>
    </div>
  )
